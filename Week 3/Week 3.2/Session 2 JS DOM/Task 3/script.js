              ...
              <div class="card">
                  <div class="status-bar">
                      <span class="availability" style="background-color: ${
                        userData.available ? "#00d861" : "#ff4444"
                      }">
                          ${userData.available ? "Friends" : "Strangers"}
                      </span>
                      <span class="rate">$${userData.rate}/hr</span>
                  </div>
                  ...
                  <h2 class="userName">${userData.fullName}</h2>
                  <h2 class="role">${userData.designation}</h2>
                  <p class="professional-status">${userData.company}</p>
          
                  <div class="skills">
                      ${skillsHTML}
                  </div>
          
                  <p class="bio">${userData.description}</p>
  
                  <button class="view-profile-btn" userIndex="${index}">
